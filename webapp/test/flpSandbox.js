		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Materiais",
									"targetURL": "#treinamentofiori-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"treinamentofiori-display": {
								"semanticObject": "treinamentofiori",
								"action": "display",
								"description": "A Fiori application by Caio Filizola",
								"title": "Materiais",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=treinamentofiori",
									"url": sap.ui.require.toUrl("treinamentofiori")
								}
							}
						}
					}
